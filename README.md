# Integration for Elementor forms - Flexmail

A lightweight but feature packed Flexmail integration for Elementor forms.
With this integration you can send your form data and contacts to Flexmail as easily as the standard integrations. 
...
5. Drag and drop the form widget of Elementor Pro from the left panel onto the content area, and find the Flexmail action in the "Actions after submit" dropdown.
6. Fill your Flexmail data and Key and you are all set. All users will be added after they submit the form.
